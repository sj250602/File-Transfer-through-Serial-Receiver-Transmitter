...
## Switches
# set_property PACKAGE_PIN V17 [get_ports {input_switch[0]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {input_switch[0]}]
# set_property PACKAGE_PIN V16 [get_ports {input_switch[1]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {input_switch[1]}]
# set_property PACKAGE_PIN W16 [get_ports {input_switch[2]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {input_switch[2]}]
# set_property PACKAGE_PIN W17 [get_ports {input_switch[3]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {input_switch[3]}]
# set_property PACKAGE_PIN W15 [get_ports {input_switch[4]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {input_switch[4]}]
# set_property PACKAGE_PIN V15 [get_ports {input_switch[5]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {input_switch[5]}]
# set_property PACKAGE_PIN W14 [get_ports {input_switch[6]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {input_switch[6]}]
# set_property PACKAGE_PIN W13 [get_ports {input_switch[7]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {input_switch[7]}]
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {led_e}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_e}]
set_property PACKAGE_PIN E19 [get_ports {led_f}]					
...
##Buttons
# set_property PACKAGE_PIN U18 [get_ports btn_r]						
# 	set_property IOSTANDARD LVCMOS33 [get_ports btn_r]
# 	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets btn_r]
# set_property PACKAGE_PIN T18 [get_ports btn_w]						
# 	set_property IOSTANDARD LVCMOS33 [get_ports btn_w]
# 	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets btn_w]
